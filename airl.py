...
class AIRL(Algorithm):
    ...
    def __init__(self, buffer_exp, state_shape, action_shape, device, seed,policy,mode,
                 ...
                 units_disc=100,disc_momentum = 0.0,use_grad_pen = True,grad_pen_weight=10,
                 num_update_loops_per_train_call = 1,  num_disc_updates_per_loop_iter = 50,
                 num_policy_updates_per_loop_iter = 50,policy_optim_batch_size_from_expert=0,
    ...
    def update(self, writer):
        ...
        for _ in range(self.num_update_loops_per_train_call):
            ...
            for epoch in range(self.num_disc_epoch):
    ...
    def update_disc(self, epoch, writer):
        ...
        if self.state_only:
            ...
            policy_disc_input = torch.cat([policy_obs, actions], dim=1)
            expert_disc_input = torch.cat([expert_obs, actions_exp], dim=1)
