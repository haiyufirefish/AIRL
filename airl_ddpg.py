...
class AIRL_DDPG(DDPG):
    ...
    def __init__(self, buffer_exp,state_shape, action_shape, device, seed, gamma=0.995, memory_size=1000000, mix_buffer=20,batch_size = 64,
                 ...
                 epoch_ddpg=50,epoch_disc=10,clip_eps=0.2, lambd=0.97, tau=0.001, coef_ent=0.0, max_grad_norm=10.0):
        super().__init__(state_shape, action_shape, device, seed, gamma, memory_size, mix_buffer, lr_actor, lr_critic,
                       units_actor, units_critic, epoch_ddpg, clip_eps, lambd, tau, coef_ent, max_grad_norm)
    ...
    def is_update(self, step):
        return super().is_update(step)

    def step(self, env, state, t, step):
        return super().step(env, state, t, step)
    ...
    def update(self, writer):
        ...
        # Update DDPG using estimated rewards.
