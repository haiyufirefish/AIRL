...
if __name__ == '__main__':
    ...
    actor = Actor(100, 128, 0.001, 10, 0.001)
    actor.build_networks()
    print(actor.network.layers[1].get_layer('fc1').get_weights()[0])
    print(actor.network.layers[1].get_layer('fc2').get_weights()[0])
    print(actor.network.layers[1].get_layer('fc3').get_weights()[0])